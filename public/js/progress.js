...
(function (root, factory) {
  ...
  function _end() {
    ...
    for (var i = 0, elmsLength = this._targetElement.length; i < elmsLength; i++) {
      ...
      var afterEndCallback = this._onAfterEndCallback;
      (function(percentElement, currentElement) {
        window.setTimeout(function() {
          if (typeof afterEndCallback === 'function') 
            afterEndCallback();
  ...
  progressJs.fn = ProgressJs.prototype = {
    ...
    onafterend: function(providedCallback) {
      if (typeof (providedCallback) === 'function') {
        this._onAfterEndCallback = providedCallback;
      } else {
        throw new Error('Provided callback for onafterend was not a function');
      }
      return this;
    },
